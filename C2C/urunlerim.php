                                ...
                                <tbody>
                                    ...
                                    while ($uruncek = $urunsor->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date("d-m-Y", strtotime($uruncek['urun_zaman'])) ?></td>
                                            ...
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    <a onclick="return confirm('Bu ürünü silmek istiyormusunuz? \nİşlem geri alınamaz...')" href="admin/netting/adminislem.php?magazaurunsil=ok&urun_id=<?php echo $uruncek['urun_id'] ?>&urunfoto_resimyol=<?php echo $uruncek['urunfoto_resimyol'] ?>"><button class="btn btn-danger btn-xs">Ürün Sil</button></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
