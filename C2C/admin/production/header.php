            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Esb-Ticaret</span></a>
                    </div>
                    ...
                    <div class="sidebar-footer hidden-small">
                        ...
                        <a href="admin-bilgi-guncelle.php" data-toggle="tooltip" data-placement="top" title="Profil Bilgilerim">
                            <span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
                        </a>
                        <a href="logout.php" data-toggle="tooltip" data-placement="top" title="Çıkış">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    <li><a href="admin-bilgi-guncelle.php"> Profil Bilgilerim</a></li>
