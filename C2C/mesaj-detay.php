...
where kullanici.kullanici_id=:id and mesaj.mesaj_id=:mesaj_id order by mesaj_zaman DESC");
              ...
              <div class="personal-info inner-page-padding">
                ...
                if ($_GET['gidenmesaj'] != "ok") { ?>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input disabled="" class="form-control" required="" name="urun_ad" id="first-name" value="<?= $mesajcek['kullanici_ad'] . " " . $mesajcek['kullanici_soyad'] ?>" type="text">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <input type="hidden" name="kullanici_gel" value="<?= $_GET['kullanici_gon'] ?>">
                  <div class="form-group">
