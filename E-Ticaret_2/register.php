	...
	<form action="admin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
		<div class="row">
			<div class="col-md-6">
				...
				<button type="submit" name="kullanicikaydet" class="btn btn-default btn-info">Kayıt İşlemini Yap</button>
			</div>
			<div class="col-md-6">
				<div class="title-bg">
					<div class="title">Şifrenizi mi Unuttunuz?</div>
				</div>
				<center><img width="400" src="img/sifremi-unuttum.jpg"></center>
			</div>
		</div>
	</form>
