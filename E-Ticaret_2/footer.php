...
<script type="text/javascript">
	window.$zopim || (function(d, s) {
		...
		$.src = "<?php echo $ayarcek['ayar_zopim'] ?>";
		z.t = +new Date;
		$.
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6"><!--footer newsletter widget-->
				<div class="title-widget-bg">
					<div class="title-widget">Mail Bültenimize Üye Olun</div>
				</div>
				<div class="newsletter">
					...
					<form role="form">
						<div class="form-group">
							...
							<input type="email" class="form-control newstler-input" id="exampleInputEmail1" placeholder="blank@blank.com">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-9">
				...
				<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author'] ?> <a href="#">E ticaret Sitesi</a></div>
				<!-- <a href="">
