                        ...
                        <div class="ibox">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    <a href="menuekle.php" class="btn btn-primary btn-sm">Menü Ekle</a>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-hover">
                                        <tbody>
                                            ...
                                            foreach ($sorgu as $satir) {
                                                ...
                                                <td class='project-title'>
                                                    <a href='project_detail.html'>$satir[menuAdi]</a>
                                                </td>
                                                <td class='project-title'>
                                                <a href='project_detail.html'>" . mb_substr($satir["aciklama"], 0, 50, "utf-8") . "</a>
                                                </td>
